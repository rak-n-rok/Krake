...
Scale the created cluster up using the example TOSCA template stored in `rak/functionals/templates/tosca/im-cluster-scale-up.yaml`.
...
.. prompt:: bash $ auto
    ...
    rok kube cluster update -f rak/functionals/templates/tosca/im-cluster-scale-up.yaml my-cluster
...
Scale the created cluster down using the example TOSCA template stored in `rak/functionals/templates/tosca/im-cluster-scale-down.yaml`.
...
.. prompt:: bash $ auto
    ...
    rok kube cluster update -f rak/functionals/templates/tosca/im-cluster-scale-down.yaml my-cluster
