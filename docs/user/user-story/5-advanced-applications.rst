...
A possible example file can be found under `rak/functionals/templates/k8s/pvc-pod.yaml`. If this file should be deployed, it is also important to
add its observer schema file found under `rak/functionals/templates/observer-schema/pvc-pod-observer-schema.yaml`.
