...
class Session(object):
    ...
    def client(self):
        ...
        """
        # FIXME: It allows for the API to be started without any connection to the
        #   database. Without this lazy loading, when the API is started, if the
        #   connection is not possible, the API will raise an exception and stop, as the
        #   connection is created at startup.
