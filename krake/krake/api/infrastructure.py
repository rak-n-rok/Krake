...
class InfrastructureApi(object):
    ...
    async def list_or_watch_global_infrastructure_providers(
        ...
        if not watch:
            return await list_resources_async(
                resource_class, GlobalInfrastructureProviderList, request, None)
    ...
    async def list_or_watch_infrastructure_providers(
        ...
        if not watch:
            return await list_resources_async(
                resource_class, InfrastructureProviderList, request, namespace)
    ...
    async def list_or_watch_global_clouds(request, heartbeat, watch, **query):
        ...
        if not watch:
            return await list_resources_async(
                resource_class, GlobalCloudList, request, None)
    ...
    async def list_or_watch_clouds(request, heartbeat, watch, **query):
        ...
        if not watch:
            return await list_resources_async(
                resource_class, CloudList, request, namespace)
